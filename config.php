...
// Username for database server login
$username = 'root';

// Password for database server login
$password = '';
...
// Option for sending email to admin
// Used during project development to disable sending email on offline localhost testing to avoid error
$send_email = true;
?>